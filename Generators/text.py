...
class Text(drawGenerator.DrawGenerator):
    ...
    def draw_text(self, 
        ...
        language_fonts = {
                # Use the filenames exactly as downloaded by the script
                "Tibetan": config.get_font_path("NotoSerifTibetan-VariableFont_wght.ttf"),
                "Hebrew": config.get_font_path("Heebo-VariableFont_wght.ttf"),
                "English": config.get_font_path("Supplemental/RobotoSlab-Regular.ttf")
                }
